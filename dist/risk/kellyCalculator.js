 ...
 */
export function netEdge(predictedProbability, effectivePricePerShare, tradingFee) {
 ...
 */
export function calculatePositionSize(predictedProbability, effectivePricePerShare, tradingFee, totalBankroll, guardrails = DEFAULT_GUARDRAILS) {
