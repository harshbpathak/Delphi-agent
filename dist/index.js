...
dotenv.config();
import { initDatabase, getState, setState, getLastEvaluation, saveEvaluation, recordTrade, recordSettlement, recentSettledPnl, performanceSnapshot, openCostByCategory, getOpenEntry, performanceStats, getOpenCost, recordPriceSnapshots, getMarketVolatility, } from './persistence/db.js';
...
async function dynamicStopLossPct(marketAddress, entryPrice) {
